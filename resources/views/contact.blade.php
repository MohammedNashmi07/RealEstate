                ...
                {{-- <div class="col-md-7">
                  <form  method="POST" role="form" class="php-email-form">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 mb-3">
                        <div class="form-group">
                          <input name="email" id="email" type="email" class="form-control form-control-lg form-control-a" placeholder="Your Email" required>
                        </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          <textarea name="message" class="form-control" id="message" cols="45" rows="8" placeholder="Message" required></textarea>
                        </div>
                      </div>
                      ...
                      <div class="col-md-12 text-center">
                        <button type="button" id="submit-btn" class="btn btn-a">Send Message</button>
                      </div>
                    </div>
                  </form>
                </div> --}}
