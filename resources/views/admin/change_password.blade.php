                ...
                <div class="card-body">
                                  ...
                                  <form  class="forms-sample" method="POST" >
                                      ...
                                      <div class="mb-3">
                                          ...
                                          <input type="password" class="form-control" id="old_password" name="password" autocomplete="off" placeholder="Input Password">
                                          <input type="hidden" value="{{$user->id}}" id="user_id">
                                      </div>
                                      <div class="mb-3">
                                          <label for="password" class="form-label">Password</label>
                                          <input type="password" class="form-control" id="new_password" name="password" autocomplete="off" placeholder="Input Password">
                                      </div>

                                      <button type="button" id="submit-btn" class="btn btn-primary me-2">Submit</button>
                                      <a href="{{route('admin.password.change')}}" class="btn btn-secondary">Cancel</a>
