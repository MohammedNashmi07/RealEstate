                            ...
                            <div class="row">
                                <div class="col-md-4 pe-md-0">
                                    <div class="authlogin-side-wrapper">
                                        <img src="{{asset('assets/images/logpages/login.jpg')}}" width="210px"
                                            height="480px" alt="" srcset="">
                                    </div>
                                </div>
                                <div class="col-md-8 ps-md-0">
                                    <div class="auth-form-wrapper px-4 py-5">
                                        <a href="#"
                                            class="noble-ui-logo logo-light d-block mb-2">Estate<span>Agency</span></a>
