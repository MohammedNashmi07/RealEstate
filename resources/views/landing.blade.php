                  ...
                  <div class="col-lg-8">
                    <div class="intro-body">
                      ...
                      <p class="intro-subtitle intro-price">
                        <a href="{{route('properties.show',[$slider_property->id])}}"><span class="price-a">Price | {{$slider_property->currency_type}} {{number_format($slider_property->price)}}</span></a>
                      </p>
                    </div>
                  </div>
                </div>
            ...
            @foreach ($latest_properties as $latest_property)
                ...
                <div class="card-box-a card-shadow">
                    ...
                    <div class="card-overlay-a-content">
                        ...
                        <a href="{{route('properties.show',[$latest_property->id])}}" class="link-a">Click here to view
                            <span class="bi bi-chevron-right"></span>
                        </a>
                        </div>
