            ...
            <div class="col-md-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('agent.update')}}" class="forms-sample" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                <label for="user_name" class="form-label">Username</label>
                                <input type="text" value="{{$user->user_name}}" class="form-control" id="user_name"
                                    name="user_name" autocomplete="off" placeholder="Input Username" required>
                                <input type="hidden" value="{{$user->id}}" name="user_id">
                            </div>
                            <div class="mb-3">
                                <label for="name" class="form-label">Name</label>
                                <input type="text" value="{{$user->name}}" class="form-control" id="name" name="name"
                                    autocomplete="off" placeholder="Input Name" required>
                            </div>
                            <div class="mb-3">
                                <label for="email" class="form-label">Email address</label>
                                <input type="email" value="{{$user->email}}" class="form-control" id="email"
                                    name="email" placeholder="Input Email" required>
                            </div>
                            <div class="mb-3">
                                <label for="phone" class="form-label">Phone</label>
                                <input type="text" value="{{$user->phone}}" class="form-control" id="phone" name="phone"
                                    autocomplete="off" placeholder="Input Phone No" required>
                            </div>
                            <div class="mb-3">
                                <label for="address" class="form-label">Address</label>
                                <input type="text" value="{{$user->address}}" class="form-control" id="address"
                                    name="address" autocomplete="off" placeholder="Input Address" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="image-container-user">
                                    <img class="fixed-shape-image" src="{{url('upload/no_image.jpg')}}"
